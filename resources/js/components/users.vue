            ...
            <tr v-for="user in users" :key="user.id">
              ...
              <td>
                <span
                  class="badge"
                  :class="
                    user.type == 'user' ? 'badge-primary' : 'badge-success'
                  "
              ...
              <td class="d-grid gap-2">
                <a @click="editModal(user)" class="btn btn-success">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form
              @submit.prevent="editMode ? editUser() : addNew()"
...
export default {
  ...
  methods: {
    ...
    editUser() {
      ...
      this.$Progress.start();
      // Submit the form via a POST request @mymakrim (How to send patch request in vform)
      this.form
        ...
        .catch((err) => {
          ...
          Toast.fire({
            icon: "fail",
            title: "User update Failed, Please Try Again!",
          });
        });
    },
    loadUsers() {
